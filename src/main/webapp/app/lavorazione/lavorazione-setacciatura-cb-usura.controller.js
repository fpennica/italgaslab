(function() {
    ...
    angular
        ...
        .controller('LavorazioneSetacciaturaCbUsuraController', LavorazioneSetacciaturaCbUsuraController);

    LavorazioneSetacciaturaCbUsuraController.$inject = ['$scope', '$state', '$stateParams', 'entity', 'Pesata', 'PesataByCampione', 'AlertService', 'uiGridConstants', '$uibModalInstance', '$uibModal', '$interval', '$timeout', '$log'];

    function LavorazioneSetacciaturaCbUsuraController ($scope, $state, $stateParams, entity, Pesata, PesataByCampione, AlertService, uiGridConstants, $uibModalInstance, $uibModal, $interval, $timeout, $log, binder) {
        var vm = this;
