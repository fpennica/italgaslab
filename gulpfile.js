// Generated on 2016-07-01 using generator-jhipster 3.4.2
'use strict';
...
gulp.task('copy', function () {
    return es.merge( 
        ...
        // task per i font di ui-grid
	    gulp.src(config.app + 'bower_components/angular-ui-grid/**/*.{woff,woff2,svg,ttf,eot,otf}')
