(function() {
    ...
    angular
        ...
        .controller('CampioneDialogController', CampioneDialogController);

    CampioneDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Campione', 'Cassetta', 'Operatore'];

    function CampioneDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Campione, Cassetta, Operatore) {
        var vm = this;
