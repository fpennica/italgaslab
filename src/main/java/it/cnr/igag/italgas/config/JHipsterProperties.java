...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "italgaslab@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "italgaslab API";

        private String description = "italgaslab API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "italgaslab";
